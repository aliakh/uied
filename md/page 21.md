...
**arduous** *(ard-you-uss) (adj)* very difficult and demanding a lot of effort.

---

**area**
1. *(n)* the size of a surface. To work out the area of a surface, you multiply its length by its width.
2. *(n)* part of a place. *A poor area of the country.*

---

**arena** *(n)* a large area, used for sports or entertainment. See **amphitheatre**, **track and field**.
...
**arid** *(adj)* Land that is arid is extremely dry because very little rain has fallen on it.

---

**arise** *arising arose arisen*
1. *(v)* If something, like a problem, arises, it comes into being.
2. *(v) (old-fashioned)* to stand up. *Arise, Sir Francis!*
...
**arithmetic** *(n)* calculations with numbers. Addition, subtraction, multiplication, and division are all types of arithmetic.

---

**arm** *arming armed*
1. *(n)* the part of your body between your shoulder and your hand.
2. *(v)* If a country arms itself, it gets ready for war.
3. **arms** *(plural n)* weapons.
...
**armchair** *(n)* a comfortable chair with supports for your arms.
...
**armour**
1. *(n)* metal covering worn by soldiers to protect them in battle. See **knight**.
2. *(n)* protective scales, spines, or shell that cover some animals, such as an armadillo. See **armadillo**.
...
**around**
1. *(prep)* surrounding, or in a circle. *He tied a rope around the tree.*
2. *(adv)* in many different parts of a place. *We travelled around Spain.*
3. *(adv)* more or less. *There were around 30 of us.*
...
**arrow**
1. *(n)* a pointed stick, shot from a bow.
2. *(n)* a sign showing a direction.

---

**arson** *(n)* If someone commits arson, they deliberately and wrongly set fire to something.

---

**art**
1. *(n)* the skill of creating something beautiful by drawing, painting, or making things with your hands.
2. *(n)* something that requires a lot of skill. *The art of Chinese cookery.*
3. **the arts** *(plural n)* forms of entertainment, such as music, theatre, and film.
...
**arthritis** *(n)* a disease which makes people's joints swollen and painful.
