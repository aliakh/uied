...
**check out** *(n)* the place in a supermarket where you pay for your goods.

---

**checkup** *(n)* a medical examination to make sure that there is nothing wrong with you.
...
**cheese** *(n)* a food made from the solid parts of milk after it has turned sour.

---

**cheetah** *(n)* a wild cat with a spotted coat that is found in Africa. Cheetahs can run faster than any other land animal.
...
**chemist**
1 *(n)* a trained person who prepares and sells drugs and medicines.
2 *(n)* a shop where you can buy drugs and medicines.

---

**chemistry** *(n)* the scientific study of substances and the ways in which they react with each other.

---

**cheque** *(n)* a printed piece of paper on which someone writes to tell their bank to pay money from their account.
...
**chess** *(n)* a game for two people with sixteen pieces each, played on a black and white board.

---

**chest**
1 *(n)* the front part of your body between your neck and waist.
2 *(n)* a large, strong box.
...
**chewing gum** *(n)* a kind of sweet that you chew for a long time, but do not swallow.

---

**chick** *(n)* a very young bird, especially a very young hen.
...
**chickenpox** *(n)* a common disease that gives you red, itchy spots on your skin.
...
**childhood** *(n)* the time when you are a child. *Marcus had a happy childhood.*
...
**child minder** *(n)* someone who looks after children while their parents are at work.
...
**chimney** *(n)* a vertical pipe through which smoke escapes from a fire. *See* **building**.

---

**chimpanzee** *(n)* a large ape with dark fur, that comes from Africa. Chimpanzees can be very intelligent. *See* **ape**.
